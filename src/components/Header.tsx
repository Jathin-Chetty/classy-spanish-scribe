...
const Header = () => (
  <header className="w-full fixed top-0 left-0 z-20 flex justify-center">
    <div className="glass-card w-[98vw] max-w-3xl mt-3 mx-2 px-6 py-3 rounded-2xl shadow-lg flex items-center justify-between bg-white/10 backdrop-blur-md border border-white/20 transition-all">
